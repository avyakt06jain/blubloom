...
export default function StatsStrip() {
  return (
    <section className="section-pad" style={{ background: C.blue, padding: '64px 48px' }}>
      <div style={{ maxWidth: 1100, margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 40, textAlign: 'center' }} className="stat-grid">
        {STATS.map((s, i) => (
          <FadeIn key={s.label} delay={i * 0.1}>
            <div className="font-playfair stats-val" style={{ fontSize: 58, fontWeight: 700, color: C.gold, lineHeight: 1 }}>
